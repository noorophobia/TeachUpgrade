...
<nav class="navbar navbar-default">
  ...
  <li><a href="HomepPgae.jsp">Home</a></li>
  <li><a href="news.asp">News</a></li>
  <li><a href="Help.jsp">Contact</a></li>
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        <div class="card mb-4">
          ...
          <div class="card-body">
            <p class="mb-4"><span class="text-primary font-bold me-1"> Personal Information</span>  
                </p>
            <div class="row">
              <div class="col-sm-3">
            ...
            <div class="row">
              ...
              <button type="button" onclick="location.href='Settings.jsp';" class= "btn btn-primary">Edit</button>
                     </br>
          ...
          <div class="col-md-6">
            <div class="card mb-4 mb-md-0">
              <div class="card-body">
                ...
                <p class="mt-4 mb-1" style="font-size: .77rem;">One Page</p>
                <div class="progress rounded" style="height: 5px;">
                  <div class="progress-bar" role="progressbar" style="width: <%=12 %>" aria-valuenow="89"
                    aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <p class="mt-4 mb-1" style="font-size: .77rem;">Mobile Template</p>
                <div class="progress rounded" style="height: 5px;">
