        ...
        <div class="card mb-4">
         <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava3.webp" alt="avatar"
          ...
          <div class="card-body">
            ...
            <p class="mb-4"><span class="text-primary font-bold me-1"> Class name</span>  
                </p>
                
                			<button type="submit"onclick="location.href='UploadVideo.jsp';" class="btn btn-primary">Create new Announcement </button>
...
try{ 
    ...
    String sql3 = "SELECT * FROM announcement where classid=? ";
  //to load driver
          ...
          while(rs.next()){
        	    ...
        	    <li ><a href="#"><%=rs.getString("title") %></a></li>
        	    <li ><a href="#"><%=rs.getString("title") %></a></li>
        	    <li ><a href="#"><%=rs.getString("title") %></a></li>
