...
public class Admin implements User {
	...
	public Admin(String username,String password,String firstName,String lastName,String emailID,String UserType){
...
public	boolean forgotPassword(String email,String uname,String pass) throws Exception {
		...
		boolean b = Admindb.verifyEmail(email,uname);
		if(b==true) {
			Admindb.updatePassword(uname,pass);
		}
		return b;
		}
@Override
public boolean login(String username, String password) throws Exception {
	...
	boolean b = Admindb.verifyUser(this);
	return b;
	}
}
